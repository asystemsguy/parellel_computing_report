...
\hline
 & Time (in hrs) & CPU (avg/max) & Memory (avg) & Vertices\\
\hline
...
We can see from the Figure~\ref{fig:performance} that the Neo4j's performance is better (1.1x - 2.1) than OrientDB.
